...
//        System.out.println("dietList: " + db.chatDao().getDietList(loginId.getLoginId()));
//        List<String> diet_buttonLabels = new ArrayList<>();
//
////        db.chatDao().getExerciseList(loginId.getLoginId()).observe(this, new Observer<List<Chat>>() {
////            @Override
...
//
//    }
//    // 이거를 로컬에서 가져오는게 아니라 db에서 가져오게만 바꾸면 됨
//    private List<String> getNamesFromResponse(String response) {
